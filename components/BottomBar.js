	...
	return (
		<div className='w-full fixed bottom-bar bg-white text-black flex justify-between items-center rounded-full px-4 py-4 pb-10 mt-8'>
			...
			{order.length > 0 ? (
				...
				<div className='bg-orange-100 text-white rounded-full px-4 py-2 flex flex-row items-center'>
					Commander <ChevronRightIcon className='w-8 h-8  p-1 text-white rounded-full' />
				</div>
			)}
		</div>
	);
